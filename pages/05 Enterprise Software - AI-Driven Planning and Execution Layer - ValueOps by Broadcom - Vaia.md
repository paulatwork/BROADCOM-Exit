...
1. **Natural-language interaction with portfolio data** - Users query and analyse project status across multiple dimensions and receive resource allocation recommendations.
2. **AI-generated business cases and data** - AI-assisted data generation produces data-driven business cases in seconds.
...
- **Natural-language interaction with portfolio data** — IBM watsonx-powered conversational agents integrated with IBM Targetprocess enable users to query project health, analyze multidimensional delivery status, and receive AI-driven capacity and resource recommendations using natural language.
...
- Using Clarity Vaia (AI) - Broadcom TechDocs (Clarity 16.4.1): https://techdocs.broadcom.com/us/en/ca-enterprise-software/business-management/clarity-project-and-portfolio-management-ppm-on-premise/16-4-1/using-clarity-vaia--ai-.html
- Human-Centric AI: How ValueOps Balances Technology and Teamwork: https://academy.broadcom.com/blog/valueops/human-centric-ai-how-valueops-balances-technology-and-teamwork
