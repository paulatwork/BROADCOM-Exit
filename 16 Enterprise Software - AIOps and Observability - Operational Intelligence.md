...
1. **Issue detection** - Automates detection of issues from alarms, metrics, traces and logs.
2. **Event correlation and noise reduction** - Correlates related events across domains to reduce alert volume.
...
- DX Operational Intelligence (product page): https://www.broadcom.com/products/software/aiops-observability/operational-intelligence
- DX Operational Intelligence - Gartner Peer Insights: https://www.gartner.com/reviews/market/aiops-platforms/vendor/broadcom/product/dx-operational-intelligence/likes-dislikes
...
- DX Operational Observability (AIOps section): https://techdocs.broadcom.com/us/en/ca-enterprise-software/it-operations-management/dx-operational-observability/saas/dx-operational-observability.html
...
- Verified with WebFetch: Broadcom TechDocs describes AIOps (Operational Intelligence) as part of DX O2. Feature list rewritten to match that wording; the ITSM integration item was removed as unverified.

### 2026-09-19 - Broadcom product information review
- Product description: Feature list carried forward from the earlier description and Broadcom product page; no 2026 release detail specific to this product was found.
...
- Confirmed (IBM product page): Cloud Pak for AIOps is now IBM Concert Operate; it ingests from over 90 monitoring tools, offers over 100 connectors, cross-tool correlation, 99 percent noise reduction, anomaly detection, and incident propagation and prioritisation.
- Not verified: the 'up to 70 percent faster' resolution figure in the file.
...
- Sources: https://www.ibm.com/products/cloud-pak-for-aiops; https://www.peerspot.com/products/ibm-cloud-pak-for-aiops-reviews
