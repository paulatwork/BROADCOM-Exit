...
- Added the ITKO LISA lineage and the observation that development has slowed.
- Searched for named organisations that replaced Service Virtualization with Parasoft, WireMock or Tricentis (2026-09-20). None was found, and the text now says so.
